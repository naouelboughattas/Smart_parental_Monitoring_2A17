    ...
    ui(new Ui::FID)
{
    ...
    //
    ui->statutf->addItem("footbaal");
    ui->statutf->addItem("dessin");
    ui->statutf->addItem("musique");
    //
    ui->scb->addItem("TYPE");
    ui->scb->addItem("DATE");
...
{
    QString p = ui->sftxt->text();
    QSqlQueryModel * model=new QSqlQueryModel();
    model->setQuery("select * from LOISIR where ID_LOISIR = '"+p+"' ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID_LOISIR"));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("TYPE "));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("LIEU"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("DATE_L"));
...
void FID::on_commandLinkButton_clicked()
{
   ...
   {
       model->setQuery("select * from LOISIR ORDER BY TYPE");
       model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID_LOISIR"));
       model->setHeaderData(3, Qt::Horizontal, QObject::tr("TYPE "));
       model->setHeaderData(2, Qt::Horizontal, QObject::tr("LIEU"));
       model->setHeaderData(1, Qt::Horizontal, QObject::tr("DATE_L"));
   ...
   {
       model->setQuery("select * from LOISIR ORDER BY DATE_L DESC");
       model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID_LOISIR"));
       model->setHeaderData(3, Qt::Horizontal, QObject::tr("TYPE "));
       model->setHeaderData(2, Qt::Horizontal, QObject::tr("LIEU"));
       model->setHeaderData(1, Qt::Horizontal, QObject::tr("DATE_L"));
