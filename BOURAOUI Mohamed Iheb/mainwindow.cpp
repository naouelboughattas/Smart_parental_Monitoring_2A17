    ...
    ui(new Ui::MainWindow)
{
    ...
    QStringList columns;
    columns << "Ascendin(0-9)" <<"Descending(9-0)"<<"Ascendin(a-z)" <<"Descending(z-a)";
...
{
    QString str ;
            str.append("<html><head></head><body><center>"+QString("<h1> Les chambres enregistr̩s <br> <br>"));
           str.append("<table border=1><tr>");
            str.append("<td>"+QString("Nom chambre")+"</td>");
            str.append("<td>"+QString("Num̩ro de chambre")+"</td>");
