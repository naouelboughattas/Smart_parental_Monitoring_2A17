...
bool lieu::ajouter()
{
    ...
    query.prepare("INSERT INTO LIEU_ATTRACTION (ID, NOM, ADRESSE, TYPE) "
...
QSqlQuery query;
QString res= QString::number(idd);
query.prepare("Delete from LIEU_ATTRACTION where ID = :id");
query.bindValue(":id", res);
...
QSqlQueryModel * lieu::afficherch(QString val)
{
    QSqlQueryModel * model=new QSqlQueryModel();
    model->setQuery("select * from LIEU_ATTRACTION where NOM = '"+val+"' ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("NOM"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("ADRESSE "));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("TYPE"));
...
QSqlQueryModel * lieu::affichern()
{
    QSqlQueryModel * model=new QSqlQueryModel();
    model->setQuery("select * from LIEU_ATTRACTION order by type desc ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("NOM"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("ADRESSE "));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("TYPE"));
...
QSqlQueryModel * lieu::affichert()
{
    QSqlQueryModel * model=new QSqlQueryModel();
    model->setQuery("select * from LIEU_ATTRACTION order by nom desc ");
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("ID"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("NOM"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("ADRESSE "));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("TYPE"));
