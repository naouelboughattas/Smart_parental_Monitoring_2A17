...
#include "ui_interface_chambres.h"
#include <QMessageBox>
...
Interface_Chambres::Interface_Chambres(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Interface_Chambres)
{
    ui->setupUi(this);
...
Interface_Chambres::~Interface_Chambres()
{
    delete ui;
}

void Interface_Chambres::on_pb_ajouter_clicked()
{
...
void Interface_Chambres::on_suprrimer_clicked()
{
...
void Interface_Chambres::on_modifier_clicked()
{
    int num=ui -> le_num -> text().toInt();
    QString nom=ui->le_nom -> text();
   Chambres ch (num ,nom);
...
void Interface_Chambres::on_pb_ajouter_2_clicked()
{
...
void Interface_Chambres::on_modifier_2_clicked()
{
    int num_etage=ui -> le_num_2 -> text().toInt();
    QString type =ui->le_type_2 -> text();
   Etages e (num_etage ,type);
...
void Interface_Chambres::on_suprrimer_2_clicked()
{
...
void Interface_Chambres::on_pushButton_sort_clicked()
{
    proxyModelEtmp.setSourceModel(Etmp.afficher());
     ui->tableView->setModel(&proxyModelEtmp);
...
void Interface_Chambres::on_pushButton_sort_2_clicked()
{
...
void Interface_Chambres::on_pushButton_search_clicked()
{
...
void Interface_Chambres::on_pushButton_search_2_clicked()
{
...
void Interface_Chambres::on_pushButton_3_clicked()
{
    QString str ;
...
void Interface_Chambres::on_pushButton_4_clicked()
{
    QString str ;
...
void Interface_Chambres::on_Sonrechech_3_clicked()
{
    //ajouter
...
void Interface_Chambres::on_Sonrechech_4_clicked()
{
    //modifier
...
void Interface_Chambres::on_Sonrechech_5_clicked()
{
    //supprimer
...
void Interface_Chambres::on_Sonrechech_6_clicked()
{
    //rechercher
...
void Interface_Chambres::on_Sonrechech_7_clicked()
{
    //ordonner
...
void Interface_Chambres::on_Sonrechech_8_clicked()
{
    //ajouter
...
void Interface_Chambres::on_Sonrechech_9_clicked()
{
    //modifier
...
void Interface_Chambres::on_Sonrechech_10_clicked()
{
    //supp
...
void Interface_Chambres::on_pushButton_5_clicked()
{
    QPrinter printer;
...
void Interface_Chambres::on_pushButton_6_clicked()
{
    QPrinter printer;
    QPrintDialog dialog(&printer, ui->tab);
    dialog.addEnabledOption(QAbstractPrintDialog::PrintSelection);
